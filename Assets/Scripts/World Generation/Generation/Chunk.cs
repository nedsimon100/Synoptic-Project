...
public class Chunk : MonoBehaviour
{
  ...
  //  public Texture2D NormalMap;
    ...
    public void drawMap(float[,] heightData, Texture2D FloorTexture, float[,] heightData2, bool[,] holeArray, Texture2D Texture2, TerrainLayer[] tl, float[,,] splateMap)
    {
        ...
        ApplyTextureToTerrain( T1, tl,splateMap);
        ApplyTextureToTerrain(Texture2, T2);
    ...
    public int TLLength;
    private void ApplyTextureToTerrain( Terrain terrain, TerrainLayer[] tls, float[,,] splatMap)
    {
        TLLength = tls.Length;
        terrain.terrainData.alphamapResolution = chunkSize + 1;
